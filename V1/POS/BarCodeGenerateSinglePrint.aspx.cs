                ...
                if (barcode != "")
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        if (dr["BarCode"].ToString().Trim() == barcode)
                        {
                            ...
                            {
                                barcodes += "<td style='padding:15px 15px;font-size:12px;font-familly:tahoma;'>" + dr["ProductName"].ToString() + "&nbsp;&nbsp;(Size: " + dr["SizeName"].ToString() + ")<br/>" + dr["StyleCode"].ToString() + "&nbsp;&nbsp;<span style='font-family:Arial;font-weight:bold;'>Hostel Management Software</span><div style='overflow: hidden; margin-left: -12px; width: 157px; height: 39px; margin-top: 0px;'><img style='margin-top: -19px;' src='http://www.bcgen.com/demo/linear-dbgs.aspx?D=";
